...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2>Servicios</h2>
            <a href="<?php echo e(route('servicios.create')); ?>" class="btn">Nuevo Servicio</a>
        </div>
     <?php $__env->endSlot(); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $servicios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servicio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('servicios.edit', $servicio)); ?>" class="action-btn">Editar</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hotel_systemax\resources\views/servicios/index.blade.php ENDPATH**/ ?>