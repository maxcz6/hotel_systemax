...
class UpdateTipoHabitacionRequest extends FormRequest
{
    ...
    {
        // El parámetro de ruta es 'tipoHabitacion' según web.php línea 30-32
        $tipoHabitacionId = $this->route('tipoHabitacion');
        ...
        return [
            'nombre' => [
                ...
                'string',
                'max:255',
                Rule::unique('tipo_habitaciones')->ignore($tipoHabitacionId),
            ],
            'descripcion' => [
                'nullable',
                'string',
