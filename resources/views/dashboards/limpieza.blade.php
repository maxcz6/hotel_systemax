<x-app-layout>
    <x-slot name="header">
        <h2>{{ __('Dashboard - Limpieza') }}</h2>
    </x-slot>

    <div class="dashboard-grid">
        <div class="dashboard-card" style="background: #fef3c7;">
            <h3>🧹 Habitaciones Pendientes de Limpieza</h3>
            <p class="big-number" style="color: #f59e0b;">{{ $habitacionesLimpieza }}</p>
        </div>
    ...
    <div style="margin-top: 2rem;">
        ...
        <div style="margin-top: 1rem;">
            <a href="{{ route('limpieza.habitaciones') }}" class="btn btn-primary">Ver Todas las Habitaciones</a>
        </div>
    </div>
